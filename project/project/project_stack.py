...
class Team26ProjectStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        user_pool = cognito.UserPool(
            self,
            id = "user-pool-team-26",
            user_pool_name="user-pool-team-26",
        ...
        user_pool.add_domain(
            "cognito-domain-team-26",
            cognito_domain=cognito.CognitoDomainOptions(
                domain_prefix="video-app-team-26"
            )
        )
        ...
        movies_bucket = s3.Bucket(
            self,
            id="movies-team-26",
            bucket_name="movies-team-26"
            )

        movies_table = dynamodb.Table(
            self, "movies-table-team-26",
            table_name="movies-table-team-26",
        ...
        genres_table = dynamodb.Table(
            self, "genres-table-team-26",
            table_name="genres-table-team-26",
            partition_key=dynamodb.Attribute(
                name="id",
                type=dynamodb.AttributeType.STRING
            ),
        ...
        actors_table = dynamodb.Table(
            self, "actors-table-team-26",
            table_name="actors-table-team-26",
            partition_key=dynamodb.Attribute(
                name="id",
                type=dynamodb.AttributeType.STRING
            ),
        ...
        directors_table = dynamodb.Table(
            self, "directors-table-team-26",
            table_name="directors-table-team-26",
            partition_key=dynamodb.Attribute(
                name="id",
                type=dynamodb.AttributeType.STRING
            ),
        ...
        feed_table = dynamodb.Table(
            self, "user-table-team-26",
            table_name="user-table-team-26",
            partition_key=dynamodb.Attribute(
                name="id",
                type=dynamodb.AttributeType.STRING
            ),
        ...
        search_table = dynamodb.Table(
            self, "search-table-team-26",
            table_name="search-table-team-26",
            partition_key=dynamodb.Attribute(
                name="movie_id",
                type=dynamodb.AttributeType.STRING
            ),
        ...
        api = apigateway.RestApi(
            self, "api-gateway-team-26",
            rest_api_name="Team 26",
        ...
        # #sqs
        dead_letter_queue = _sqs.Queue(self, "upload-dead-queue-team26", queue_name="upload-dead-queue-team-26")

        upload_queue = _sqs.Queue(
            self, "upload-queue-team-26",
            visibility_timeout=Duration.minutes(5),
            queue_name="upload-queue-team-26",
